...
**Combat level math stays automated** (ally bonuses, magical item bonuses, world bonus) as a _base_ — but players can override the final total manually when a card effect changes it.
...
3. Else normal; MANUAL\_\* moves for own cards always included
